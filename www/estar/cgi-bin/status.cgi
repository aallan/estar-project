...
print "<P>Real time status information on the <a href='http://estar5.astro.ex.ac.uk/robonet-1.0/cgi-bin/status.cgi'>Robonet-1.0 Status Page</a> <img src='http://www.estar.org.uk/wiki/uploads/7/7a/Padlock_Icon.jpg' /></P>\n";
...
print "<P>Real time status information on the <a href='http://estar7.astro.ex.ac.uk/ukirt/cgi-bin/status.cgi'>UKIRT Status Page</a> <img src='http://www.estar.org.uk/wiki/uploads/7/7a/Padlock_Icon.jpg' /></P>\n";

my $adp_icon_string;
if( $adp_status eq "UP" ) {
  $adp_icon_string = '<img src="../gif/icon_green.gif" />';
} elsif ( $adp_status eq "FAULT" ) {
  $adp_icon_string = '<img src="../gif/icon_yellow.gif" />';
} else {  
  $adp_icon_string = '<img src="../gif/icon_red.gif" />';
}
...
print "<P>Real time status information on the <a href='http://estar1.astro.ex.ac.uk/robonet-1.0/cgi-bin/status.cgi'>ADP Status Page</a> <img src='http://www.estar.org.uk/wiki/uploads/7/7a/Padlock_Icon.jpg' /></P>\n";
