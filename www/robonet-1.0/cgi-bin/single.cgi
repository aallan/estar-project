...
# M A I N   L O O P  #########################################################
  ...
  $node = "FTN" if $node eq "132.160.98.239:8080/org_estar_nodeagent/services/NodeAgent";
  ...
  $node = "FTS" if $node eq "150.203.153.202:8080/org_estar_nodeagent/services/NodeAgent";
  my $score;
