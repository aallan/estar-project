...
my $inc;
unless ( open ( FILE, "<../events/ogle.inc") ) {
   print "Content-type: text/html\n\n";
   error( 'Can not open ogle.inc file' );
   exit;
}
{
   undef $/;
...
$header =~ s/PAGE_TITLE_STRING/OGLE Message Timeline/g;
...
print 'The <a href="http://www.estar.org.uk/wiki/index.php/OGLE">OGLE</a> event time line is shown above, there are two independently scrollable bars (the upper in days, the lower in months), which can be panned by clicking and dragging to show previous events. The currently visible view in the upper scrollable area is represented by a light grey box on the lower area. Each <a href="http://www.estar.org.uk/wiki/index.php/OGLE">OGLE</a> event is represented by a marker, labelled with the event name, and clicking on the marker will bring up additional data and links for that event.';

print '<h3>Event List</h3>';
print '<P><a href="http://www.estar.org.uk/wiki/index.php/OGLE">OGLE</a> event messages are also available via an <a href="http://www.estar.org.uk/voevent/eSTAR/eSTAR.rdf" class="external text" title="http://www.estar.org.uk/voevent/eSTAR/eSTAR.rdf" rel="nofollow">RSS event feed</a> <span class="plainlinks"><a href="http://www.estar.org.uk/voevent/eSTAR/eSTAR.rdf" class="external text" title="http://www.estar.org.uk/voevent/eSTAR/eSTAR.rdf" rel="nofollow"><img src="http://www.estar.org.uk/wiki/uploads/8/8b/Xml-button.jpg" alt="Xml-button.jpg" /></a><span> <span class="plainlinks"><a href="http://www.estar.org.uk/voevent/eSTAR/eSTAR.rdf" class="external text" title="http://www.estar.org.uk/voevent/eSTAR/eSTAR.rdf" rel="nofollow"><img src="http://www.estar.org.uk/wiki/uploads/0/09/Rss.png" alt="Rss.png" /></a><span></P>';
print $inc;
