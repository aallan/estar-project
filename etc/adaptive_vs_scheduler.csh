...
#  History:
#     $Log: adaptive_vs_scheduler.csh,v $
#     Revision 1.1  2007/05/03 14:24:43  saunders
#     ADP startup script
#
...
#  Revision:
#     $Id: adaptive_vs_scheduler.csh,v 1.1 2007/05/03 14:24:43 saunders Exp $
...
if (-e $PERL ) then
  ...
  echo "--------------------------------"
  echo "Please wait..."
  echo "Starting Adaptive Variable Star Agent (${ia_args} )"
  ${PERL} ${ESTAR_DIR}/bin/adaptive_vs_scheduler.pl ${ia_args}
